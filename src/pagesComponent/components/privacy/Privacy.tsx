    ...
    <>
      ...
      <div className={styles.page}>
        ...
        <div>
          ...
          <p>
            We may collect or process various categories of Personal
            Information. The section directly below titled, “Personal
            Information We Collect, Use, and Share,” contains information on the
            categories of Personal Information collected and/or whether we sell
            or share Personal Information. As an overview, we may collect
            identifiers, personal information categories contained in customer
            records, characteristics of protected classifications, commercial
            information, professional or employment-related information,
            education information, internet, technical, or other similar
            electronic network activity information, sensitive Personal
            Information, and inferences drawn from other Personal Information.
            We retain the information for as long as needed to meet the purpose
            of processing and in accordance with this Policy.
          </p>
          <p>
            ...
            the methods provided in the, “CONTACT US,” section below. To
            exercise your right to ask that we do not sell, share, or use your
            Personal Information for targeted advertising send an e-mail
        ...
        <div>
          ...
          <p>
            ...
            indirectly, with a particular individual, device, or household.
            Below, we describe how we will handle your Personal Information in
            accordance with this Policy and describe the information we may have
            collected, how it may be used or shared, and the sources below.
          </p>
        </div>
        <div>
          ...
          <p>
            ...
            to us through our forms on our Sites, including the information you
        ...
        <div>
          ...
          <div>
            We may obtain additional information about you from third parties
            such as marketers, affiliates, partners, researchers, social
            networks, service providers, data services companies, and others. We
            may combine information that we collect from you with information
            about you that we obtain from such third parties and information
            derived from any other subscription, product, or service we provide.
            We may also obtain Personal Data indirectly, such as from publicly
            available sources (e.g., websites or publicly accessible databases),
            third-party data vendors, and third-party partners and
            collaborators. We may combine Personal Data from multiple online and
            offline sources.
          </div>
        </div>
      </div>
